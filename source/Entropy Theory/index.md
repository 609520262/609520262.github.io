...
<div class="header_down">
    ...
    <div class="ds-banner__content">
      ...
      <span class="field--formatter-ds-html-string field field--name-title field--type-string field--label-hidden"><h1 class="ds-text-shadow ds-banner__title">SOLIDWORKS 3D CAD</h1>
</span>

            <div class="field--formatter-ds-html-string field field--name-field-subtitle field--type-string field--label-hidden field__item"><h2 class="ds-text-shadow ds-banner__subtitle">SOLIDWORKS 3D CAD 解决方案提供了易于学习且极为强大的功能，可以缩短产品开发时间、降低成本并改进质量。</h2>
</div>
